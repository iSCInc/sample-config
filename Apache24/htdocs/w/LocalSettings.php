...
$wgEmergencyContact = "apache@inc.isc";
$wgPasswordSender = "apache@inc.isc";
...
$wgImageMagickConvertCommand = "C:\\Program Files (x86)\\ImageMagick-6.9.2-Q16\\convert.exe";
...
$wgSecretKey = "<Generated Secret Key Here>";

# Site upgrade key. Must be set to a string (default provided) to turn on the
# web installer while LocalSettings.php is in place
$wgUpgradeKey = "<Generated Upgrade Key Here>";
